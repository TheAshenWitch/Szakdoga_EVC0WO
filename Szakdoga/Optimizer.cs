...
namespace Szakdoga
{
    internal class Optimizer
    {
        ...
        //    }
        //}
        public List<Piece> TryFitMorePieces(List<Piece> pieces, int sheetId, double offsetX, double offsetY, double availWidth, double availHeight, double sheetPadding, double BladeThickness)
        {
